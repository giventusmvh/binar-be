...
public class SuperAdminServiceImpl implements SuperAdminService {
    ...
    public UserResponse getUserById(Long userId) {
        User user = userRepository.findByIdWithRolesAndProfile(userId)
    ...
    public RoleResponse updateRolePermissions(Long roleId, AssignPermissionRequest request) {
        ...
        Set<Permission> permissions = new HashSet<>(permissionRepository.findByIdIn(request.getPermissionIds()));
