...
public class LoanApplicationMapper {
  ...
  public LoanApplicationResponse toResponse(LoanApplication loan) {
    ...
    return LoanApplicationResponse.builder()
        ...
        .customerSelfiePath(loan.getCustomerSelfiePathSnapshot())
        .customerSalarySlipPath(loan.getCustomerSalarySlipPathSnapshot())
        .customerJob(loan.getCustomerJobSnapshot())
        .customerCompanyName(loan.getCustomerCompanyNameSnapshot())
